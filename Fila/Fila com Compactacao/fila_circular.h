...
void fila_insere(Fila *f, float v) {
    ...
    // final já passou do limite = voltar para o início
...
void mostra_fila(Fila *f) {
    ...
    } else { // se inicio for maior ou igual ao final
        for (int i = f->inicio; i < f->tamVetor; i++) // printar do f->inicio até o índice 4
            printf("%.0f\n", f->vet[i]);
